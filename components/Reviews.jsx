...
export default function ReviewsPage({ productId: propProductId }) {
  ...
  return (
    <div className="max-w-7xl mx-auto md:py-12 py-6 px-4 bg-white">
      ...
      <div className="bg-amber-50 rounded-2xl shadow-sm border border-amber-200 md:p-8 p-4 mb-6 md:mb-8">
        <div className="grid md:grid-cols-3 md:gap-8 gap-6 items-center">
          {/* Average Rating */}
          <div className="text-center">
            <div className="flex justify-center mb-2">
              <StarRating rating={average} size="md:w-10 md:h-10 w-8 h-8" />
            </div>
            <p className="md:text-3xl text-xl font-bold text-gray-800">{average.toFixed(1)} out of 5</p>
          ...
          <div className="text-center">
            <button
              ...
              className="bg-[#7d4b0e] hover:bg-yellow-600 text-white font-semibold md:py-3 py-2 px-8 rounded-full transition shadow-md cursor-pointer"
            >
              WRITE A REVIEW
            </button>
          </div>
