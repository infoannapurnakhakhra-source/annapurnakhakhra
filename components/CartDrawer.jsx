...
export default function CartDrawer({
  ...
  useEffect(() => {
    async function loadCart() {
      ...
      try {
        ...
        // Trigger suggestions refetch after cart loads
  ...
  // Extract currentCartItems for suggestions (variant IDs as shopifyProductId)
  const currentCartItems = cart?.lines?.edges?.map(({ node }) => ({
    shopifyProductId: node.merchandise.id.split("/").pop(), // e.g., "123456789" from gid://shopify/ProductVariant/123456789
  })) || [];
    ...
    try {
      ...
      if (data.success) {
        ...
        if (sessionId) {
          ...
          // Send via sendBeacon (reliable even if page closes)
  ...
  const placeOrder = async () => {
    ...
    try {
      ...
      if (paymentMethod === "payu") {
        ...
        // Save pending order (recommended)
        localStorage.setItem("pendingPayUOrder", JSON.stringify(orderPayload));
        ...
        const res = await fetch("/api/payu/initiate", {
          ...
          body: JSON.stringify({
            ...
            phone: address.phone,
            firstname: address.firstName,
            productinfo: "Order Checkout",
            orderRef: `ORD_${Date.now()}`,
          }),
        });
        ...
        form.method = "POST";
        form.action = "https://secure.payu.in/_payment"; // test: https://test.payu.in/_payment
  ...
  const handleProceedToCheckout = () => {
    ...
    // 🏠 ✅ DEFAULT ADDRESS (ONLY IF AVAILABLE)
                ...
                {loading ? (
                  ...
                  <>
                    <div className="relative overflow-hidden">
                      ...
                      {/* Confetti Cannon Effects - Cross pattern from bottom corners */}
                      {isFreeDelivery && (
                        <div className="absolute inset-0 pointer-events-none z-20 overflow-hidden">
                          {/* Left Bottom Confetti Cannon - Shoots diagonally up-right */}
                          ...
                          {/* Right Bottom Confetti Cannon - Shoots diagonally up-left */}
                          ...
                          {/* Extra confetti from left spreading wide */}
                          ...
                          {/* Extra confetti from right spreading wide */}
                    ...
                    <style jsx>{`
                        ...
                        /* Left diagonal confetti - shoots up-right in cross pattern */
                        ...
                        /* Right diagonal confetti - shoots up-left in cross pattern */
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <button
                        ...
                        className="w-full mt-4 px-4 py-3 bg-amber-100 text-[#7d4b0e] rounded-lg font-semibold hover:bg-amber-200 transition-all flex items-center justify-center gap-2 disabled:opacity-50 cursor-pointer"
                      >
                        {isCalculating ? (
                          <>
