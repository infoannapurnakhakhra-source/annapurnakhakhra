...
export default function KhakhraGallery() {
  ...
  const products = [
    ...
    { id: "panipuri-khakhra-made-with-pure-ghee", src: "/Navratri Friends Group Enjoying Khakhra.webp", alt: "Panipuri Khakhra", title: "Panipuri Khakhra", description: "Tangy panipuri-flavored crispy khakhra snack." },
    { id: "manchurian-khakhra-made-with-pure-ghee", src: "/Diwali Family Eating Khakhra.webp", alt: "Manchurian Khakhra", title: "Manchurian Khakhra", description: "Mumbai-style Manchurian taste packed in thin khakhra." },
  ];
