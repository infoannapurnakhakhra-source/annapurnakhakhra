    ...
    return (
      <div className="flex flex-col items-center justify-center h-screen bg-gray-100">
        ...
        <button
          ...
          className="px-8 py-2 bg-[#0A1721] text-white rounded-lg hover:bg-[#132838] transition-all duration-300 cursor-pointer"
        >
          Back to Blogs
        </button>
      </div>
  ...
  return (
    <div className="px-6 sm:px-12 py-12">
      <article className="max-w-5xl mx-auto">
        <button
          onClick={() => router.back()}
          className="flex items-center text-amber-600 mb-6 font-semibold hover:underline cursor-pointer"
        >
